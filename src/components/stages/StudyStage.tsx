...
interface StudyStageProps {
  ...
  nextStageAfterStudy: 'quiz' | 'lines'
  ...
  onGoStage: (stage: 'mnemonic_practice' | 'quiz' | 'lines') => void
        ...
        <HStack mt={4} justify="flex-end">
          <Button colorScheme="blue" isDisabled={!studyItemCompleted} onClick={() => {
            ...
            if (next < elements.length) {
              ...
              onGoStage('lines')
              onSaveProgress({ stage: 'lines', timelineConfirmed: true })
            }
          }}>Continuar</Button>
        </HStack>
      </>
      ...
      <>
        ...
        <HStack mt={4} justify="flex-end">
          <Button colorScheme="blue" isDisabled={!studyItemCompleted} isLoading={isSavingMnemonic} onClick={async () => {
            ...
            if (next < elements.length) {
              onSetIndex(next)
              onSaveProgress({ stage: 'study', studyIndex: next, studyItemCompleted: false, mnemonicCreatorConfirmed: true })
            } else {
